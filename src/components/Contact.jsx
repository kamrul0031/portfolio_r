...
function Contact() {
  ...
  return (
    ...
    >
      <div className="bg-slate-800 text-white md:col-span-2 md:row-span-8 rounded-3xl uppercase p-4 flex flex-col gap-2">
        ...
        <ul className="flex gap-3 flex-col">
          ...
          <motion.li
            initial={ContainerVariant.hidden}
            whileInView={ContainerVariant.visible}
            className=" bg-slate-900 rounded-2xl h-32 md:h-24 flex items-center px-5 gap-5"
          >
            <div className="border p-2 rounded-full">
              {/* <img className='w-16' src={icon} alt="" /> */}
              <svg
      ...
      <div className="bg-slate-800  md:col-span-4 md:row-span-12 text-white h-[35rem] md:h-auto rounded-3xl uppercase p-4 flex items-center flex-col gap-2">
        ...
        <ul className="w-full flex flex-col gap-4">
          ...
          >
            <button className=" capitalize bg-slate-700 font-bold p-[0.6rem] rounded-xl">
              send message
            </button>
          </motion.li>
        </ul>
